...
/**
 * Covers the read/write/convert round trips of {@link JsonCodec}, the recursive deep {@code copy},
 * and the alphanumeric field sorting applied by {@code writeAsPrettyPrintedString}.
 */
@Test(groups = "unit")
public class JsonCodecTest {
  ...
  public void testCopyIsDeepAndIndependent () {
    ...
    Assert.assertNotSame(copy.get("outer"), original.get("outer"));
  }
