    ...
    if ((sort != null) && (!sort.isEmpty())) {
      ...
      for (SortField sortField : sort.getFields()) {
        ...
        switch (sortField.getDirection()) {
          case ASC -> orderList.add(criteriaBuilder.asc(wherePath.getPath()));
          case DESC -> orderList.add(criteriaBuilder.desc(wherePath.getPath()));
          default -> throw new UnknownSwitchCaseException(sortField.getDirection().name());
        }
      }
