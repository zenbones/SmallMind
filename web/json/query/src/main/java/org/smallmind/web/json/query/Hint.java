...
/**
 * Abstract base for type metadata that describes how to interpret an array operand's element values.
 */
...
public abstract class Hint {
  ...
  /**
   * Returns the discriminator identifying the concrete hint subtype.
   *
   * @return hint type
   */
