...
public class WebSocketApplicationInstaller {
  ...
  public WebSocketApplication getWebSocketApplication ()
    ...
    return (webSocketApplication != null) ? webSocketApplication : webSocketApplicationClass.newInstance();
  }
  ...
  public void setWebSocketApplicationClass (Class<? extends WebSocketApplication> webSocketApplicationClass) {

    this.webSocketApplicationClass = webSocketApplicationClass;
  }
