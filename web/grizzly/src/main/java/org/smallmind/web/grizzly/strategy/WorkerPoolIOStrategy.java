...
public class WorkerPoolIOStrategy extends WorkManager<IOStrategyWorker, IOPackage> implements IOStrategy, WorkerFactory<IOStrategyWorker, IOPackage> {
  ...
  @Override
  public IOStrategyWorker createWorker (MetricConfiguration metricConfiguration, TransferQueue<IOPackage> transferQueue) {

    return new IOStrategyWorker(metricConfiguration, transferQueue);
  }
