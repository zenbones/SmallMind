...
/**
 * Integration smoke test that boots an embedded Jetty server through a real Spring
 * {@code ContextRefreshedEvent} (the lifecycle {@link JettyInitializingBean} listens for), issues an HTTP
 * request against a registered Jersey resource, and shuts the server down on context close.
 */
