...
public class TransmissionListener implements SessionEmployer, MessageListener {
  ...
  public TransmissionListener (MessageTransmitter messageTransmitter, ConnectionBroker responseConnectionBroker, Topic responseTopic)
    throws JMSException {
    ...
    responseConnectionBroker.createConsumer(this);
  }
