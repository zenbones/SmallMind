...
public class MessagingTransmitter {
  ...
  public MessagingTransmitter (MessagingConnectionDetails messagingConnectionDetails, int transmissionPoolSize)
  ...
  public MessageSender borrowMessageSender (String serviceSelector)
    throws ComponentPoolException {

    return messageSenderPool.getComponent().setServiceSelector(serviceSelector);
  }
