...
public class QueueOperator implements SessionEmployer {
  ...
  public QueueOperator (ConnectionBroker requestConnectionBroker, Queue requestQueue) {
  ...
  public Session getRequestSession ()
    ...
    return requestConnectionBroker.getSession(this);
  }

  public void send (Message message)
    throws JMSException {

    requestConnectionBroker.getProducer(this).send(message);
  }
}
