...
public class MessageSenderConnectionInstanceFactory implements ConnectionInstanceFactory<MessageSender, MessageSender> {
  ...
  private final Juggler<TransportManagedObjects, QueueConnection> queueConnectionJuggler;
  private final Queue queue;
  private final MessagePolicy messagePolicy;
  private final MessageStrategy messageStrategy;
  private final int timeoutSeconds;

  public MessageSenderConnectionInstanceFactory (Juggler<TransportManagedObjects, QueueConnection> queueConnectionJuggler, Queue queue, MessagePolicy messagePolicy, MessageStrategy messageStrategy, int timeoutSeconds) {
  ...
  public ConnectionInstance<MessageSender> createInstance (ConnectionPool<MessageSender> connectionPool)
    ...
    return new MessageSenderConnectionInstance(connectionPool, queueConnectionJuggler.pickResource(), queue, messagePolicy, messageStrategy, timeoutSeconds);
  }
