...
public class MessagingWorker implements MessageListener {
  ...
  public MessagingWorker (QueueConnection queueConnection, Queue queue, MessageTarget messageTarget)
    throws JMSException {

    this(queueConnection, queue, messageTarget, null);
  }

  public MessagingWorker (QueueConnection queueConnection, Queue queue, MessageTarget messageTarget, String serviceSelector)
    throws JMSException {
    ...
    queueReceiver = (serviceSelector == null) ? queueSession.createReceiver(queue) : queueSession.createReceiver(queue, MessagingConnectionDetails.SELECTION_PROPERTY + "='" + serviceSelector + "'");
