 ...
 * version 3.
 */
package org.smallmind.quorum.pool.complex.remote.spring;
...
public class RemoteComponentPoolFactoryBean implements FactoryBean<RemoteComponentPoolSurface> {
  ...
  public RemoteComponentPoolSurface getObject ()
    throws Exception {

    RemoteEndpointBinder.bind(new RemoteComponentPoolSurfaceImpl(componentPool), registryName);

    return RemoteProxyFactory.generateRemoteProxy(RemoteComponentPoolSurface.class, registryName);
  }

  public Class getObjectType () {

    return RemoteComponentPoolSurface.class;
  }
