...
public class RemoteComponentPoolEventListener implements ComponentPoolEventListener, RemoteEndpoint {

  private static final Class[] REMOTE_INTERFACES = new Class[] {ComponentPoolEventListener.class};

  private ComponentPoolEventListener targetListener;

  public RemoteComponentPoolEventListener (ComponentPoolEventListener targetListener) {
  ...
  public void reportErrorOccurred (ErrorReportingComponentPoolEvent event) {
    ...
    targetListener.reportErrorOccurred(event);
  }

  @Override
  public void reportLeaseTime (LeaseTimeReportingComponentPoolEvent event) {

    targetListener.reportLeaseTime(event);
  }
}
