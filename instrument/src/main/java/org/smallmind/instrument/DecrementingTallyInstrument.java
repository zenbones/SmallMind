...
public abstract class DecrementingTallyInstrument extends Instrument<Tally> {
  ...
  public DecrementingTallyInstrument (MetricConfigurationProvider provider, MetricProperty... properties) {
  ...
  public DecrementingTallyInstrument (Metrics.MetricBuilder<Tally> builder, String domain, MetricProperty... properties) {

    super(new InstrumentationArguments<>(builder, domain, properties));
  }

  public abstract void withTally ()
    throws Exception;

  @Override
  public final void with (Tally tally)
    throws Exception {
