...
public abstract class SpeedometerInstrumentAndReturn<T> extends InstrumentAndReturn<Speedometer, T> {
  ...
  public SpeedometerInstrumentAndReturn (MetricConfigurationProvider provider, MetricProperty... properties) {
  ...
  public SpeedometerInstrumentAndReturn (Metrics.MetricBuilder<Speedometer> builder, String domain, MetricProperty... properties) {

    super(new InstrumentationArguments<>(builder, domain, properties));
  }

  public abstract T withSpeedometer (AtomicLong valueRef)
    throws Throwable;

  @Override
  public final T with (Speedometer speedometer)
    throws Throwable {

    T result;
    AtomicLong valueRef = new AtomicLong(1);

    result = withSpeedometer(valueRef);
