...
public class Bounded extends AbstractStatistic<MinAndMax, MinAndMax> {
  ...
  @Override
  public MinAndMax get () {

    return new MinAndMax(minAccumulator.get(), maxAccumulator.get());
  }

  @Override
  public void get (MinAndMax holder) {

    holder.setMinimum(minAccumulator.get());
    holder.setMinimum(maxAccumulator.get());
  }
