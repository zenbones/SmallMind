...
public class LocalTransportConfiguration {
  ...
  public LocalTransportConfiguration setLongPollResponseDelayMilliseconds (long longPollResponseDelayMilliseconds) {
  ...
  public LocalTransportConfiguration setLongPollAdvisedIntervalMilliseconds (long longPollAdvisedIntervalMilliseconds) {
  ...
  public LocalTransportConfiguration setClientTimeoutMilliseconds (long clientTimeoutMilliseconds) {
  ...
  public LocalTransportConfiguration setLazyMessageMaximumDelayMilliseconds (long lazyMessageMaximumDelayMilliseconds) {
  ...
  public LocalTransportConfiguration setMetaConnectDeliveryOnly (boolean metaConnectDeliveryOnly) {
