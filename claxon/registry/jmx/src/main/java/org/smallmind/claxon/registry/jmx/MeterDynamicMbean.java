...
public class MeterDynamicMbean implements DynamicMBean {
  ...
  public void setAttribute (Attribute attribute)
    ...
    if (attributeNameSet.contains(attribute.getName())) {
      if (double.class.equals(attribute.getValue().getClass())) {
        valueMap.put(attribute.getName(), (double)attribute.getValue());
      } else if (Double.class.equals(attribute.getValue().getClass())) {
        valueMap.put(attribute.getName(), (Double)attribute.getValue());
      } else if (String.class.equals(attribute.getValue().getClass())) {
        valueMap.put(attribute.getName(), new Double((String)attribute.getValue()));
      } else {
