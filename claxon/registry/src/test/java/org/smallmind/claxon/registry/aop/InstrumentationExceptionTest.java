...
public class InstrumentationExceptionTest {
  ...
  public void testCauseIsPreserved () {
    ...
    InstrumentationException exception = new InstrumentationException(cause);
  ...
  public void testIsRuntimeException () {
    ...
    Assert.assertTrue(new InstrumentationException(new RuntimeException()) instanceof RuntimeException);
  }
}
