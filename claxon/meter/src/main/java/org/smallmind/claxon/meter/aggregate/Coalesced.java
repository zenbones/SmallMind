...
public class Coalesced extends AbstractAggregate {
  ...
  public Coalesced () {
    ...
    this(null, Calculation.AVERAGE, TimeUnit.SECONDS, new Stint(1, TimeUnit.SECONDS));
  }

  public Coalesced (String name) {

    this(name, Calculation.AVERAGE, TimeUnit.SECONDS, new Stint(1, TimeUnit.SECONDS));
  }

  public Coalesced (Calculation calculation, TimeUnit velocityTimeUnit, Stint pulseStint) {

    this(null, calculation, velocityTimeUnit, pulseStint);
  }
