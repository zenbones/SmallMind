...
public class Stratified extends AbstractAggregate {
  ...
  public Stratified () {
    ...
    this(null, 1, 3600000L, 2, new Stint(1, TimeUnit.SECONDS));
  }

  public Stratified (String name) {

    this(name, 1, 3600000L, 2, new Stint(1, TimeUnit.SECONDS));
  }

  public Stratified (Stint windowStint) {

    this(null, 1, 3600000L, 2, windowStint);
  }

  public Stratified (long lowestDiscernibleValue, long highestTrackableValue, int numberOfSignificantValueDigits) {

    this(null, lowestDiscernibleValue, highestTrackableValue, numberOfSignificantValueDigits, new Stint(1, TimeUnit.SECONDS));
  }

  public Stratified (String name, Stint windowStint) {

    this(name, 1, 3600000L, 2, windowStint);
  }

  public Stratified (String name, long lowestDiscernibleValue, long highestTrackableValue, int numberOfSignificantValueDigits) {

    this(name, lowestDiscernibleValue, highestTrackableValue, numberOfSignificantValueDigits, new Stint(1, TimeUnit.SECONDS));
  }

  public Stratified (long lowestDiscernibleValue, long highestTrackableValue, int numberOfSignificantValueDigits, Stint windowStint) {

    this(null, lowestDiscernibleValue, highestTrackableValue, numberOfSignificantValueDigits, windowStint);
  }

  public Stratified (String name, long lowestDiscernibleValue, long highestTrackableValue, int numberOfSignificantValueDigits, Stint windowStint) {
