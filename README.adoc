...
<beans xmlns="http://www.springframework.org/schema/beans"
  ...
  <bean id="emitterMap" class="com.forio.epicenter.skeleton.instrument.claxon.spring.EmitterMapFactoryBean">
    <property name="key" value="prometheus"/>
    <property name="emitter" ref="claxonEmitter"/>
  </bean>
  ...
  <bean id="claxonRegistry" class="org.smallmind.claxon.registry.spring.ClaxonRegistryFactoryBean">
          ...
          <bean class="org.smallmind.claxon.registry.ImpliedNamingStrategy">
            <property name="prefixMap">
              <map>
                ...
                <entry value="com.forio.epicenter.metric.pool">
                  <key>
                    <bean class="org.smallmind.nutsnbolts.util.DotNotation">
                      <property name="notation" value="org.smallmind.quorum.pool.*"/>
                    </bean>
                  </key>
                </entry>
                <entry value="com.forio.epicenter.metric.push">
                  <key>
                    <bean class="org.smallmind.nutsnbolts.util.DotNotation">
                      <property name="notation" value="com.forio.epicenter.skeleton.push.v4.*"/>
                    </bean>
                  </key>
                </entry>
                <entry value="com.forio.epicenter.metric.task">
                  <key>
                    <bean class="org.smallmind.nutsnbolts.util.DotNotation">
                      <property name="notation" value="com.forio.epicenter.ontology.gestalt.v3.task.*"/>
                    </bean>
                  </key>
                </entry>
                <entry value="com.forio.epicenter.metric.task">
                  <key>
                    <bean class="org.smallmind.nutsnbolts.util.DotNotation">
                      <property name="notation" value="com.forio.epicenter.ontology.gestalt.v4.task.*"/>
                    </bean>
                  </key>
                </entry>
                <entry value="com.forio.epicenter.metric.unknown">
                  <key>
                    <bean class="org.smallmind.nutsnbolts.util.DotNotation">
                ...
                <entry value="com.forio.epicenter.metric.wire">
                  <key>
                    <bean class="org.smallmind.nutsnbolts.util.DotNotation">
                      <property name="notation" value="org.smallmind.phalanx.wire.*"/>
                    </bean>
                  </key>
                </entry>
                <entry value="com.forio.epicenter.metric.worker">
                  <key>
                    <bean class="org.smallmind.nutsnbolts.util.DotNotation">
                      <property name="notation" value="org.smallmind.phalanx.worker.*"/>
                    </bean>
                  </key>
                </entry>
              </map>
    ...
    <property name="emitterMap" ref="emitterMap"/>
  </bean>
</beans>
----
