...
* *timestamp* (_org.smallmind.scribe.pen.Timestamp_) - Controls how dates are formatted. Defaults to "yyyy-MM-dd'T'HH:mm:ss.SSSZ".
* *format* (_String_) - Here's where it gets a little complex...
+
====
The operation of the format string is similar to that of _String_ formatting Flags. Portrayed as a regular expression, each Flag has the general form of...
