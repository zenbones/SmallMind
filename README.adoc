...
* *Gauge* - Emits the "minimum", "maximum" and "average" of the updated values.
* *Histogram* - Emits the "count" of values over the collection cycle, the "velocity" of updates, the "minimum", "maximum", "mean", and a set of specified quantiles.
* *Speedometer* - Emits the "minimum", "maximum" and "velocity" of the updated values.
* *Tachometer* - Emits just the "velocity" of the updated values.
* *Tally* - Emits the running total of all updated values (which can be both positive and negative).
