...
The following is one possible configuration that demonstrative of a simple but realistic scenario. It's in Spring xml format, but should be indicative of what's necessary in any injection framework...
