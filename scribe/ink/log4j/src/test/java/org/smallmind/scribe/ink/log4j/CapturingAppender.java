...
/**
 * A minimal {@link AbstractAppender} that captures every record it receives, used to verify that
 * the Log4j2 logger adapter routes scribe records through to the wrapped scribe appender.
 */
