...
public class SLF4JLoggingBlueprint extends LoggingBlueprint<SLF4JRecord> {
  ...
  public Record<SLF4JRecord> errorRecord (Record<SLF4JRecord> record, Throwable throwable, String message, Object... args) {

    SLF4JRecord slf4jRecord;
    LoggerContext loggerContext;

    slf4jRecord = new SLF4JRecord(record.getLoggerName(), Level.FATAL, throwable, message, args);
    loggerContext = new DefaultLoggerContext();
    loggerContext.fillIn();
    slf4jRecord.setLoggerContext(loggerContext);
