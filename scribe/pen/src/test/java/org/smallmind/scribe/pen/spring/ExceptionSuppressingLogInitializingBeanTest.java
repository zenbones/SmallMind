...
public class ExceptionSuppressingLogInitializingBeanTest {
  ...
  public void testSuppressedExceptionIsBlockedByTheFilter () {
    ...
    ExceptionSuppressingLogInitializingBean initializingBean = new ExceptionSuppressingLogInitializingBean();

    initializingBean.setSuppressedThrowableClasses(new Class[] {UniqueSuppressedTestException.class});
    initializingBean.afterPropertiesSet();

    ExceptionSuppressingLogFilter filter = new ExceptionSuppressingLogFilter();
