...
/**
 * A minimal {@link AbstractAppender} that captures every record it receives, used to assert the
 * end-to-end behaviour of {@link ScribeLoggerAdapter} against a real scribe logging pipeline.
 */
