...
/**
 * Test appender that captures every published {@link Record} into a thread-safe list so that tests can
 * assert on what reached the end of the logging pipeline.
 */
