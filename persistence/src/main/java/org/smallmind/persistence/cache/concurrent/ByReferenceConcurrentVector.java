...
@InstrumentedClass
public class ByReferenceConcurrentVector<I extends Serializable & Comparable<I>, D extends Durable<I>> extends ConcurrentDurableVector<I, D> {
  ...
  public DurableVector<I, D> copy () {
    ...
    return new ByReferenceConcurrentVector<I, D>(new ConcurrentRoster<D>(roster), getComparator(), getMaxSize(), getTimeToLive(), isOrdered());
  }
}
