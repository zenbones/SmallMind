...
public class Tester {
  ...
  public static void main (String... args) {
    ...
    MongoClientSettings settings = MongoClientSettings.builder().applyToClusterSettings(builder -> builder.hosts(List.of(new ServerAddress("localhost", 27017)))).build();
    ...
    for (Fooz fooz : mongoTemplate.find(Query.query(Criteria.where("color").is("purple")), Fooz.class)) {
