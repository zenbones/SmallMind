...
/**
 * Simple in-memory message carrying a byte payload and associated properties, used by the mock transport.
 */
public class MockMessage {
  ...
  /**
   * Returns the mutable properties object for this message.
   *
