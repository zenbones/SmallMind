...
import org.smallmind.bayeux.oumuamua.spi.json.jackson.JacksonStringValue;
...
public interface Body<V extends Value<V>> extends ObjectValue<V> {
  ...
  default String getId () {
    ...
    return (((value = get(Message.ID)) != null) && ValueType.STRING.equals(value.getType())) ? ((JacksonStringValue)value).asText() : null;
  }
  ...
  default String getSessionId () {
    ...
    return (((value = get(Message.SESSION_ID)) != null) && ValueType.STRING.equals(value.getType())) ? ((JacksonStringValue)value).asText() : null;
  }
  ...
  default String getChannel () {
    ...
    return (((value = get(Message.CHANNEL)) != null) && ValueType.STRING.equals(value.getType())) ? ((JacksonStringValue)value).asText() : null;
  }
