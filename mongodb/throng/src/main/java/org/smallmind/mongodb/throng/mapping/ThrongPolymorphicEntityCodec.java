...
public class ThrongPolymorphicEntityCodec<T> extends ThrongPropertiesMultiplexerCodec<T> implements ThrongRootCodec<T> {
  ...
  public ThrongPolymorphicEntityCodec (ThrongEntityMultiplexer<T> throngEntityMultiplexer) {
    ...
    collection = throngEntityMultiplexer.getCollection();
