...
/**
 * Checked exception raised during Throng entity registration when annotations are invalid, codecs cannot be resolved,
 * or the entity model violates mapping constraints.
 */
