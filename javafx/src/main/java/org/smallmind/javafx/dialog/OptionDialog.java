...
import org.smallmind.javafx.ImageNotFoundException;
...
public class OptionDialog extends AbstractDialog {
  ...
  public OptionDialog (String optionText, OptionType optionType, final OptionPane optionPane, OptionButton... optionButtons) {
    ...
    try {
      optionImage = new ImageView(new Image(Thread.currentThread().getContextClassLoader().getResourceAsStream("org/smallmind/javafx/dialog/dialog_" + optionType.getImageType() + ".png")));
    }
