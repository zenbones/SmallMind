...
public class InfiniteScrollEvent<S> extends Event {
  ...
  protected InfiniteScrollEvent (EventType<InfiniteScrollEvent> eventType, InfiniteScrollingTableView<S> source) {
  ...
  public static EventType<InfiniteScrollEvent> getAny () {

    return ANY;
  }

  public InfiniteScrollingTableView<S> getSource () {
