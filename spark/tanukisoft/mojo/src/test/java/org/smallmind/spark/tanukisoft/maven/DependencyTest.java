...
public class DependencyTest {
  ...
  public void testMatchesOnlyWhenBothCoordinatesAgree () {
    ...
    Assert.assertTrue(dependency("org.smallmind", "smallmind-nutsnbolts").matchesArtifact(artifact("org.smallmind", "smallmind-nutsnbolts")));
  }

  public void testDifferentGroupDoesNotMatch () {

    Assert.assertFalse(dependency("org.smallmind", "smallmind-nutsnbolts").matchesArtifact(artifact("org.other", "smallmind-nutsnbolts")));
  }

  public void testDifferentArtifactDoesNotMatch () {

    Assert.assertFalse(dependency("org.smallmind", "smallmind-nutsnbolts").matchesArtifact(artifact("org.smallmind", "smallmind-scribe")));
  }
}
