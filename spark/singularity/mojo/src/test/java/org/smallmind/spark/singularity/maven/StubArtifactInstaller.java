...
/**
 * Capturing {@link ArtifactInstaller} double that records the file and artifact handed to it, and can be told to fail
 * so the Mojo's exception-translation path can be exercised.
 */
