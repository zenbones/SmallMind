...
public class ClassVerifierTest {
  ...
  public void testUnsignedClassReturnsFalse ()
    ...
    Assert.assertFalse(ClassVerifier.verifySignature(ClassVerifierTest.class, store, "JKS", "any-alias"));
  }

  public void testUnsignedClassReturnsFalseForDefaultKeystoreType ()
    throws Exception {
  ...
  private static class InMemorySecureStore extends SecureStore {
    ...
    InMemorySecureStore (byte[] bytes) {
