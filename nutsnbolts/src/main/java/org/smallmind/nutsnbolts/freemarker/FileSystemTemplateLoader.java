...
public class FileSystemTemplateLoader implements TemplateLoader {
  ...
  public FileSystemTemplateLoader (ClassLoader classLoader) {
  ...
  public FileSystemTemplateLoader (Class<?> anchorClass) {

    this(anchorClass, false);
  }

  public FileSystemTemplateLoader (Class<?> anchorClass, boolean relative) {
