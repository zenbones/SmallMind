...
/**
 * Enumeration of Edwards-curve (EdDSA) asymmetric signing algorithms supported by the library.
 */
public enum EdDSASigningAlgorithm implements AsymmetricSigningAlgorithm {
   ...
   */
  EdDSASigningAlgorithm (String algorithmName) {
