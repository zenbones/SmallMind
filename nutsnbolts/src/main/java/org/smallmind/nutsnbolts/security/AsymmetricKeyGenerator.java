...
public class AsymmetricKeyGenerator {
  ...
  public static void main (String... args)
    ...
    KeyPair keyPair = EncryptionUtility.generateKeyPair(AsymmetricAlgorithm.valueOf(args[0].toUpperCase()));

    System.out.println(AsymmetricKeySpec.OPENSSH.fromKey(keyPair.getPublic()));
    System.out.println(AsymmetricKeySpec.PKCS8.fromKey(keyPair.getPrivate()));
  }
}
