...
import org.smallmind.throng.wire.mock.MockRequestTransport;
import org.smallmind.throng.wire.mock.MockResponseTransport;
...
public class MockWireTest {
  ...
  public void beforeClass ()
    ...
    /*
    context = new ClassPathXmlApplicationContext("org/smallmind/foundation/foundation.xml", "org/smallmind/scribe/spring/test-logging.xml", "org/smallmind/throng/wire/rabbitmq-wire.xml");
    ...
    */
    ...
    /*
    context = new ClassPathXmlApplicationContext("org/smallmind/foundation/foundation.xml", "org/smallmind/scribe/spring/test-logging.xml", "org/smallmind/throng/wire/hornetq-wire.xml");
    ...
    */
    ...
    context = new ClassPathXmlApplicationContext("org/smallmind/foundation/foundation.xml", "org/smallmind/scribe/spring/test-logging.xml", "org/smallmind/throng/wire/mock-wire.xml");
    ...
    wireTestingService = (WireTestingService)WireProxyFactory.generateProxy(requestTransport, 1, "WireTestService", WireTestingService.class, null);
  }
