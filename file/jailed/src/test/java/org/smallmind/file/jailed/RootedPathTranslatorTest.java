...
@Test(groups = "unit")
public class RootedPathTranslatorTest {

  private JailedFileSystem jailedFileSystem;
  private RootedPathTranslator translator;
  private Path rootPath;

  @BeforeClass
  public void beforeClass () {

    rootPath = FileSystems.getDefault().getPath(System.getProperty("user.dir"));
    translator = new RootedPathTranslator(rootPath);
  ...
  public void testGetNativeFileSystem () {
  ...
  public void testWrapAbsoluteUnderRoot () {
    ...
    Assert.assertEquals(jailed.toString(), "/alpha/beta");
  ...
  public void testUnwrapAbsoluteJailedPath () {
    ...
    Assert.assertTrue(native_.isAbsolute());
  ...
  public void testRoundTrip () {
    ...
    Path back = translator.unwrapPath(jailed);
